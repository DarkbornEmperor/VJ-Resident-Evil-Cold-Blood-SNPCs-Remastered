...
ENT.RECB = {"npc_vj_recbb1_zombie_male","npc_vj_recbb1_zombie_female","npc_vj_recbb1_zombie_hunk","npc_vj_recbb1_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_crimsonhead","npc_vj_recb_cerberus","npc_vj_recb_hunter","npc_vj_recb_licker","npc_vj_recb_crawler","npc_vj_recb_snake","npc_vj_recb_flyclaw","npc_vj_recb_crow","npc_vj_recb_spider_giant","npc_vj_recb_ant"}
ENT.RECB2 = {"npc_vj_recbb1_zombie_male","npc_vj_recbb1_zombie_female","npc_vj_recbb1_zombie_hunk","npc_vj_recbb1_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_crimsonhead","npc_vj_recb_cerberus","npc_vj_recb_hunter","npc_vj_recb_licker","npc_vj_recb_crawler","npc_vj_recb_snake","npc_vj_recb_flyclaw","npc_vj_recb_crow","npc_vj_recb_spider_giant","npc_vj_recb_ant"}
ENT.RECB3 = {"npc_vj_recbb1_zombie_male","npc_vj_recbb1_zombie_female","npc_vj_recbb1_zombie_hunk","npc_vj_recbb1_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_zombie_male","npc_vj_recb_zombie_female","npc_vj_recb_zombie_soldier","npc_vj_recb_zombie_torso","npc_vj_recb_crimsonhead","npc_vj_recb_cerberus","npc_vj_recb_hunter","npc_vj_recb_licker","npc_vj_recb_crawler","npc_vj_recb_snake","npc_vj_recb_flyclaw","npc_vj_recb_crow","npc_vj_recb_spider_giant","npc_vj_recb_ant"}
...
if v:IsValid() && v != self && v.RECBControl == true then 
...
self.CREA = false	
self.zombied = ents.Create(VJ_PICK(self.RECB))
...
self.CREAd = false	
self.zombied1 = ents.Create(VJ_PICK(self.RECB2))
...
self.CREAda = false	
self.zombied1a = ents.Create(VJ_PICK(self.RECB3))
